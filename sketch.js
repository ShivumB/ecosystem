function draw() {
  ...
  switch (scene) {
    ...
    case "game":
      ...
      push();
      translate(39, 40);
      rotate(settingsTheta);
      image(settingsSprite, -20, -20, 38, 40);
      pop();

      if (mouseX > 20 && mouseX < 60 && mouseY > 20 && mouseY < 60) {
        settingsTheta += 0.3 * (30 - settingsTheta);
      } else {
        settingsTheta += 0.3 * (0 - settingsTheta);
      }
    ...
    case "settings":
      ...
      text("carrot settings", 950 + 350 / 2, 80);
      text("water settings", 950 + 350 / 2, 280);
      text("resume simulation", 950 + 350 / 2, 517);
